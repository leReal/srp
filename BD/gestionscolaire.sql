...
ALTER TABLE `eleves` ADD `MATRICULE` VARCHAR( 20 ) NOT NULL FIRST ;
ALTER TABLE  `eleves` ADD  `LIEU_NAISS` VARCHAR( 255 ) NOT NULL
...
ALTER TABLE `evaluer` CHANGE `MOYENE` `MOYENE` DECIMAL( 10, 2 ) NULL DEFAULT NULL ;
...
---
-- Creation de la table COURS_CLASSE par GPT 
---
CREATE TABLE `cours_classe` (
`COURS_CLASSE_ID` INT NOT NULL AUTO_INCREMENT ,
`COURS_ID` INT NOT NULL ,
`CLASSE_ID` INT NOT NULL ,
`COEF` INT NOT NULL ,
`DATE_ENTREE` DATE NOT NULL ,
PRIMARY KEY ( `COURS_CLASSE_ID` )
) ENGINE = MYISAM ;