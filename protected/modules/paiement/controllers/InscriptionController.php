...
class InscriptionController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Inscription']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->inscription_id));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Inscription');
	...
	{
		$model=Inscription::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Inscription $model the model to be validated
	 */
