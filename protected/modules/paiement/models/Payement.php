...
class Payement extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('ANNEEACADEMIQUE_ID, ELEVE_ID, TYPE_PAIEMENT_ID, ESEIGNANT_ID, ACCESOIRE_ID, ETABLISSEMENT_ID, DATE, MONTANT, payement_id', 'safe', 'on'=>'search'),
		);
	}
